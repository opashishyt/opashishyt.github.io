        ...
        <div class="project-card" data-id="${project.id}">
            ...
            <div class="project-content">
                ...
                <div class="project-actions">
                    ...
                    ${project.liveUrl ? `
                        <a href="${project.liveUrl}" target="_blank" class="btn btn-sm btn-secondary" onclick="event.stopPropagation()">
...
function showNotification(message, type = 'info') {
    ...
    // Remove existing style if any
    const existingStyle = document.querySelector('#notificationStyle');
    if (existingStyle) existingStyle.remove();
...
function loadUserData() {
    ...
    const userData = JSON.parse(localStorage.getItem('portfolio_user_data')) || {
        ...
        email: 'ashish.kumar@portfolio.com',
